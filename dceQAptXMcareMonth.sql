    ...
    SELECT DISTINCT
        ...
        , CASE
            ...
            WHEN src_bene_mdcr_stus_cd IN ('11','21','31') 
                AND src_bene_entlmt_buyin_ind IN ('3','C')  --try query with and without the buyin lines
                THEN '1'
            -- 2 = Disabled
...
LEFT JOIN prod_common.ref.code_month m1
 ...
 LEFT JOIN prod_common.ref.code_month m2
    on 
--record_status_cd ='a'   ---comment this filter
--    AND 
    ...
    AND bene_status.row_num != 1 
WHERE month_cd >= 'm-2021-08'
--'m-2021-12' --7,447 w/ assgn modification
--'m-2021-11' --6,844 w/ assgn modification
--'m-2021-10' --6,842 w/ assgn modification
--AND assgn_medicare_status_cd in ('4')
--('1','2','3','4')
--    ;
)   
SELECT month_cd
